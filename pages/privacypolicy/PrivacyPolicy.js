...
const PrivacyPolicy = () => {
    return (
        <div className='PrivacyContainer'>
            <h3 className='PrivacyHeading1'>
                Privacy Policy
            </h3>
            <h4 className='PrivacyHeading2'>
                Version 1.1
            </h4>
