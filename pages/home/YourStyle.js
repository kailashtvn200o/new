...
const YourStyle = () => {
    return (
        <div className={heads.subcontainer1}      >
                    ...
                    <div className={styles['heroimage-widget']}>
                        ...
                        <Carousel.Caption className={styles['text-left']}>
                            <div className={styles.caption}>
                                <div className={styles.blueheading}>Let your style shine</div>
                                ...
                                <a href="#download" className={styles['btn btn-primary']}>Personalise Your Style</a>
